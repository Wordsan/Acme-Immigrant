...
@Transactional
public class SocialSectionServiceTest extends AbstractTest {
	...
	protected void template(final String user, final Class<?> expected) {
		...
		try {
			...
			c.setNickname("jose");
			c.setSocialNetwork("tuite");
			c.setLinkProfile(RandomUtilities.generarURL());
			this.socialSectionService.save(c);
