...
public class CreditCardImmigrantController extends AbstractController {
	...
	public ModelAndView list() {
		...
		final Immigrant immigrant = this.immigrantService.getActorByUA(LoginService.getPrincipal());
	...
	public ModelAndView create() {
		ModelAndView result;
		CreditCard cc;
		final Immigrant i = this.immigrantService.getActorByUA(LoginService.getPrincipal());
		Assert.notNull(i);
		cc = new CreditCard();
	...
	public ModelAndView save(@Valid final CreditCard cc, final BindingResult binding) {
		ModelAndView result;
		...
		if (binding.hasErrors())
			...
			try {
				...
				result = this.createEditModelAndView(cc, "creditCard.commit.error");
			}
		return result;
	}
	...
	protected ModelAndView createEditModelAndView(final CreditCard cc, final String messageCode) {
		ModelAndView result;
		final Immigrant i = this.immigrantService.getActorByUA(LoginService.getPrincipal());
